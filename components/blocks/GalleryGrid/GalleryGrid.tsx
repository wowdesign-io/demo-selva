    ...
    <>
      <div className="gallery__head">
        <div className="gallery__intro">
          <span className="gallery__label reveal">The Gallery</span>
          <h2 className="gallery__heading reveal" data-delay="100">Forty residences,<br />one botanical world</h2>
        </div>
      ...
      <div className="gallery__grid" id="galleryGrid">
        {ITEMS.map((it) => {
          ...
          return (
            <figure key={it.src} className={`gallery__item${hidden ? ' is-hidden' : ''}`} data-cat={it.cat}>
