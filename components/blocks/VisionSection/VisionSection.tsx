...
export interface VisionTeaserBlok {
  ...
  cta_text?: string; cta_href?: SbLink | string; image?: SbAsset; alt?: string
...
export default function VisionSection({ blok }: { blok?: VisionTeaserBlok }) {
  ...
  const ctaLink  = resolveLink(blok?.cta_href, '/vision')
      ...
      <div className="vision__copyBand">
        ...
        <div className="vision__inner">
          ...
          <div className="vision__bodyCol">
            ...
            <a href={ctaLink.href} target={ctaLink.target} rel={ctaLink.rel} className="vision__cta reveal" data-delay="440">
