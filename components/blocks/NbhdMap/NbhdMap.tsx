...
const DEFAULT_PINS: MapPin[] = [
  ...
  { key: 'marina',   label: 'Bayfront Marina',      lng: -80.2445, lat: 25.7245, colorVar: 'var(--color-water)'      },
  { key: 'coast',    label: 'Coastal Park',         lng: -80.2448, lat: 25.7315, colorVar: 'var(--color-water)'      },
  { key: 'sailing',  label: 'Sailing Club',         lng: -80.2462, lat: 25.7220, colorVar: 'var(--color-water)'      },
